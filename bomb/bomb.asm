...
0000000000401062 <phase_5>:
  ...
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)     保存canary
  401078:	31 c0                	xor    %eax,%eax
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>
  40107f:	83 f8 06             	cmp    $0x6,%eax           字符长6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx    rbx+rax_->rcx 第一个字母传到
  40108f:	88 0c 24             	mov    %cl,(%rsp) 
  401092:	48 8b 14 24          	mov    (%rsp),%rdx           
  401096:	83 e2 0f             	and    $0xf,%edx  
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx  ionefg
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)  dl->rsp+rax+10
